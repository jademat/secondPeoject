    ...
    <div class="container-fluid py-5">
        ...
        <div class="row px-xl-5">
			...
			<form class="validation-form"
				...
				<br> <label for="id">결제 수단</label> <br>
					...
					<button type="button" name="selectedCard" value="MASTER" class="btn p-0">
						<div class="card" style="width: 300px; height: 160px;">
							...
							<a href="#" onclick="selectCard('신한카드')"> <img
								...
								<div class="card-body" style="padding: 8px; height: 30%; display: flex; flex-direction: column; justify-content: center;">
									<p class="card-text"
				...
				<div class="mb-3">
					<label for="selectPayment">선택된 결제 수단</label> 
					<input type="text" class="form-control" id="selectPayment" placeholder=""
