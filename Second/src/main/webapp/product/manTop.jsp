...
List<ProductDTO> list = dao.manTop();
				...
				<ul class="pagination justify-content-center mb-3">
					...
					<c:if test="${page > block }">
						<li class="page-item"><a class="page-link"
							href="user_manTop.go?page=1">⏪</a></li>
						<li class="page-item"><a class="page-link"
							href="user_manTop.go?page=${startBlock - 1 }">◀</a></li>
					</c:if>
					...
					<c:forEach begin="${startBlock }" end="${endBlock }" var="i">
						<c:if test="${i == page}">
							<li class="page-item active"><a class="page-link"
								href="user_manTop.go?&page=${ i }">${ i }</a></li>
						</c:if>
						<c:if test="${i != page}">
							<li class="page-item"><a class="page-link"
								href="user_manTop.go?page=${ i }">${ i }</a></li>
					...
					<c:if test="${endBlock < allPage}">
						<li class="page-item"><a class="page-link"
							href="user_manTop.go?page=${endBlock + 1 }">▶</a></li>
						<li class="page-item"><a class="page-link"
							href="user_manTop.go?page=${ allPage }">⏩</a></li>
					</c:if>
				</ul>
			</div>
			<!-- 페이지네이션 끝 -->
