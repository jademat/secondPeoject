...
<link
	href="<%=request.getContextPath()%>/resource/lib/owlcarousel/assets/owl.carousel.min.css"
	rel="stylesheet">
...
<link href="<%=request.getContextPath()%>/resource/css/style.css"
	rel="stylesheet">
<script
	...
	<div class="container-fluid">
		<div class="row bg-secondary py-2 px-xl-5">
			<div class="col-lg-6 d-none d-lg-block">
				<div class="d-inline-flex align-items-center">
					<a class="text-dark"
						href="<%=request.getContextPath()%>/user_board_list.go?board_type=all">FAQs</a>
				</div>
			</div>
		...
		<div class="row align-items-center py-3 px-xl-5">
			<div class="col-lg-3 d-none d-lg-block">
				<a href="<%=request.getContextPath()%>/user_main.go"
					class="text-decoration-none">
					<h1 class="m-0 display-5 font-weight-semi-bold">
						<span class="text-primary font-weight-bold border px-3 mr-1">E</span>HHLB
					</h1>
				</a>
			</div>
		</div>
				...
				<nav
					...
					<div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
						<div class="nav-item dropdown">
							<a href="#" class="nav-link" data-toggle="dropdown"> Woman<i
								class="fa fa-angle-down float-right mt-1"></i></a>
							<div
								class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
								<a href="<%=request.getContextPath()%>/user_womanAll.go"
									class="dropdown-item"> See All</a> <a
									href="<%=request.getContextPath()%>/user_womanTop.go"
									class="dropdown-item"> Top </a> <a
									href="<%=request.getContextPath()%>/user_womanBottom.go"
									class="dropdown-item"> Bottom </a> <a
									href="<%=request.getContextPath()%>/user_womanOuter.go"
									class="dropdown-item"> Outer </a>
							</div>
						</div>
						<div class="nav-item dropdown">
							<a href="#" class="nav-link" data-toggle="dropdown"> Man <i
								class="fa fa-angle-down float-right mt-1"></i></a>
							<div
								class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
								<a href="<%=request.getContextPath()%>/user_manAll.go"
									...
									class="dropdown-item"> Bottom </a> <a
									href="<%=request.getContextPath()%>/user_manOuter.go"
									class="dropdown-item"> Outer </a>
							</div>
				</nav>
			</div>
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="<%=request.getContextPath()%>/user_main.go"
								...
								href="<%=request.getContextPath()%>/user_shop.go"
							...
							<a
								href="<%=request.getContextPath()%>/user_board_list.go?board_type=all"
								class="nav-item nav-link">Board</a> <a
								href="<%=request.getContextPath()%>/user_review_list.go"
						...
						<div class="navbar-nav ml-auto py-0">
							...
							<c:if test="${!empty user_id}">
								<a
									href="<%=request.getContextPath() %>/user_myInfo.go?id=${sessionScope.user_id}"
									class="nav-item nav-link">myInfo</a>
								<a href="<%=request.getContextPath()%>/user_logout.go"
