...
<head>
    ...
    <!-- template 사용자 정의 스타일 -->
    <link href="<%=request.getContextPath() %>/resource/startbootstrap_admin_pages/css/sb-admin-2.css" rel="stylesheet" />
...
<body id="page-top">
    ...
    <li class="nav-item">
        ...
        <div id="collapseProductManagement" class="collapse" aria-labelledby="headingProductManagement" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="category_management.jsp">카테고리 관리</a>
                <a class="collapse-item" href="product_management.jsp">상품 관리</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseMemberManagement" class="collapse" aria-labelledby="headingMemberManagement" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="inquiries.html">1:1 문의 처리</a>
                <a class="collapse-item" href="membership_approval.html">회원 탈퇴 승인</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSalesManagement" class="collapse" aria-labelledby="headingSalesManagement" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="sales_by_day.html">일자별</a>
                <a class="collapse-item" href="sales_by_month.html">월별</a>
            </div>
        </div>
    </li>
         ...
         <script>
			$(document).ready(function() {
			    $(".nav-link").click(function(e) {
			        ...
			        var url = $(this).attr('href'); // 클릭한 메뉴의 URL 가져오기
			        ...
			        $.ajax({
			            ...
			            success: function(response) {
			                // 받은 응답을 content-area에 삽입
			                $("#content-area").html(response);
			            },
			            error: function(xhr, status, error) {
			                alert("메뉴 로드 실패: " + error);
			            }
			        });
			    });
			});
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">관리자님 반갑습니다.</h1>
